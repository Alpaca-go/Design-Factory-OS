...
export function compileBenchmarkQueryPlan(visualFacts) {
  ...
  return validateBenchmarkQueryPlan({
    direct_industry_queries: [query([identity.industry, ...tags.industry_tags, 'visual identity'], '识别同行业的有效视觉代码', 'direct_industry', exclusions, 'high')],
    ...
    tone_price_queries: [query([offer.price_tier, ...positioning.desired_perception, ...positioning.emotional_tone, 'brand system'], '寻找相近价格带与气质的审美机制', 'tone_price', exclusions)],
